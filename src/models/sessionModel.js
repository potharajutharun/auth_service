...
export const createSession = async (sessionData) => {
    const { user_id, tenant_id, jwt_id, ip_address, device_name, user_agent, refresh_token, } = sessionData;
    await db.query(`INSERT INTO sessions 
      (user_id, tenant_id, jwt_id, ip_address, device_name, user_agent, refresh_token) 
     VALUES (?, ?, ?, ?, ?, ?, ?)`, [user_id, tenant_id, jwt_id, ip_address, device_name, user_agent, refresh_token]);
};
// ---------------------------
//  Find Session
// ---------------------------
